...
#define ANYCUBIC_PROBE_VERSION 2 // @zen default for Linear Plus
// Heated Bed:
// 0 ... no heated bed
// 1 ... aluminium heated bed with "BuildTak-like" sticker
// 2 ... ultrabase heated bed
#define ANYCUBIC_KOSSEL_ENABLE_BED 1 // @zen Linear Plus option
...
#define STRING_CONFIG_H_AUTHOR "@zen" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "zKossel Delta"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "zKossel"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 267.25 // mm
  ...
  #define DELTA_HEIGHT 390.00 // get this value from auto calibrate
...
// @zen just set default drivers for clarity
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 94 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 200, 200} // @zen this machine can do better
 ...
 */
//#define S_CURVE_ACCELERATION // @zen not to enable together with LINEAR ADVANCE since 8-bit cannot handle it
...
#define PREHEAT_1_FAN_SPEED   0 // @zen don't blow during heatup

#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED     70 // @zen defaults for PET-G, since I don't use ABS
#define PREHEAT_2_FAN_SPEED   0 // @zen don't blow during heatup
